...
class DebitOrdersCreateBank extends StatefulWidget {
  const DebitOrdersCreateBank({Key? key}) : super(key: key);
  @override
  _DebitOrdersCreateBank createState() => _DebitOrdersCreateBank();

}

class _DebitOrdersCreateBank extends State<DebitOrdersCreateBank> {
  ...
  final TextEditingController textFieldAccountNumber = TextEditingController();
                    ...
                    Center(
                      child: Column(
                        children: [
                          ...
                          const Padding(
                            padding: EdgeInsets.only(bottom: 8.0, left: 15.0, right: 12.0),
                            child: Text('To Bank'),
                          ),
                          ...
                          Padding(
                            ...
                            child: TextField(
                              textAlign: TextAlign.left,
                              controller: textFieldAccountNumber,
                              keyboardType: TextInputType.text,
                              decoration: InputDecoration(
                                fillColor: Theme.of(context).dividerColor,
