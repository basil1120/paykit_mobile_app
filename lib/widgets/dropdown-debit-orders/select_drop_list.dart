...
class _SelectDropListState extends State<SelectDropList> with SingleTickerProviderStateMixin {
  ...
  _SelectDropListState(OptionItem itemSelected, DropListModel dropListModel);
            ...
            children: <Widget>[
              Expanded(
                  child: GestureDetector(
                    ...
                    child: Text(optionItemSelected.title, style: const TextStyle(color: Colors.black, fontSize: 16),),
                  )
              ),
              Align(
                alignment: const Alignment(1, 0),
                child: Icon(
                  isShow ? Icons.arrow_drop_down : Icons.arrow_right, color: Colors.black,
                  size: 20,
                ),
              ),
            ],
